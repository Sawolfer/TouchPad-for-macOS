...
// MARK: - ViewModel
class MultipeerViewModelMACOS: NSObject, ObservableObject {
...
extension MultipeerViewModelMACOS: MCSessionDelegate {
...
extension MultipeerViewModelMACOS: MCNearbyServiceAdvertiserDelegate {
...
extension MultipeerViewModelMACOS: MCNearbyServiceBrowserDelegate {
...
extension MultipeerViewModelMACOS: StreamDelegate {
    func session(_ session: MCSession, didReceive stream: InputStream, withName streamName: String, fromPeer peerID: MCPeerID) {
